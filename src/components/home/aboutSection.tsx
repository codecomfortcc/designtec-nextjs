const AboutSection = () => {
  return (
    <div id='section-2' className="h-64 mb-20 mt-20 w-full border-t-2  border-b-2 border-solid ">
      <div className="w-full h-full flex flex-col gap-5 justify-center items-center">
        <h1  className="md:text-4xl font-bold text-gray-400 text-center text-3xl">
          ...
          <span id='loyal-customers' className="text-primary text-5xl">loyal customers</span>{" "}
