...
import logo from "@/assets/main-page-image.png";
...
const HeroSection = () => {
  ...
  return (
    <div id='section-1' className="w-full mt-20 mb-20 flex justify-center">
      <div className="max-w-[1280px] w-full ">
        <div id="section-1" className="w-full h-full flex gap-2  ">
          <div className="w-full flex h-full gap-5 flex-col max-md:justify-center max-md:items-center">
            <h3  id='brand-name' className="text-3xl font-medium ml-2  "> DESIGNTEC </h3>

            <div className="flex flex-col gap-10 max-md:justify-center max-md:items-center">
              <h1 id='slogan' className="md:text-8xl sm:text-7xl text-5xl font-bold max-md:flex max-md:items-center max-md:flex-col">
                <span id='slogan-head'>
                  Pure{" "}
                ...
                <span id='slogan-tail'>Pure Life</span>
              </h1>
              <p id='info' className="ml-2 max-w-[400px] max-md:text-center">
            ...
            <div className="ml-2">
              <Button  id='main-button' className="flex gap-2 rounded-full px-8 py-4 hover:bg-white hover:border-primary hover:border-2 hover:text-primary  transition-all duration-200 ease-in-out  ">
